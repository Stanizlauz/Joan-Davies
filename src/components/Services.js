                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={100}>
                            <div className="icon-box iconbox-blue">
                                ...
                                <h4><a href>Planning & Research</a></h4>
                                <p>I do a lot of planning and extensive research before I start up any trade, investment or financial adventure. These two keywords have been the bedrock of my success over the years</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay={200}>
                            <div className="icon-box iconbox-orange ">
                                ...
                                <h4><a href>Analysis & Development</a></h4>
                                <p>Analysing your market based on the high/low index is the next step to follow through before going on any trade. Always develop the right strategy to trade with before investing in a market.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay={300}>
                            <div className="icon-box iconbox-pink">
                                ...
                                <h4><a href>Testing & Review</a></h4>
                                <p>Before going all in, I test my strategy with demo accounts or starting small. This gives me feedback with data to review and decide if I'm sticking to a particular strategy or not.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay={100}>
                            <div className="icon-box iconbox-yellow">
                                ...
                                <h4><a href>Trading Without Restrictions</a></h4>
                                <p>Once you've gone through these processes and developed your unique trading strategy, you're good to go. Remember, There's always need to review incase your strategy falls through</p>
                            </div>
                        </div>
